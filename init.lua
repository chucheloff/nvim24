...
-- center search
vim.keymap.set('n', 'n', 'nzzzv', { desc = 'Center screen on next search result' })
vim.keymap.set('n', 'N', 'Nzzzv', { desc = 'Center screen on previous search result' })
